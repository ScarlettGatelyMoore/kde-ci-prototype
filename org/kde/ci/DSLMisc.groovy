...
class DSLMisc {	
	...
	static Closure LogRotatorClosure() {
		def logrotateOR = new CIOverrides()
		def (daysToKeep, numToKeep, artifactDaysToKeep, artifactNumToKeep) = logrotateOR.logrotator ?: ["-1","10","-1","-1"]
		return {
