		...
		switch(platform) {
			case 'Linux':
				...
				if (lin_custom_command) {
					...
					jobcommand.append('python2 ' + '${JENKINS_SLAVE_HOME}/scripts/tools/update-setup-sandbox.py\n')
					jobcommand.append('python2 ' + '${JENKINS_SLAVE_HOME}/scripts/tools/perform-build.py ' + '--project ' + "${jobname}" + ' --branchGroup ' + "${branchGroup}"	\
			...
			case 'android':
				...
				if (android_job_command) {
					...
					jobcommand.append('python2 ' + '/home/jenkins/scripts/tools/update-setup-sandbox.py\n')
					jobcommand.append('python2 ' + '/home/jenkins/scripts/tools/perform-build.py')
